...
class FullHorizontalCut(CuttingMethod):
    ...
    def cutBiRectangle(self, biRectangle: BiRectangle) -> list[Rectangle]:
        ...
        return [Rectangle(big_r.x_min, little_r.x_min, big_r.y_min, big_r.y_max),
                Rectangle(big_r.x_min, big_r.x_max, little_r.y_max, big_r.y_max),
                Rectangle(big_r.x_min, big_r.x_max, big_r.y_min, little_r.y_min),
                Rectangle(little_r.x_max, big_r.x_max, big_r.y_min, big_r.y_max)]
